...
<body>
<div id="container">
    <form:form id="inputForm" modelAttribute="sPmAppUpload" action="${ctx}/partyManage/sPmAppUpload/save" method="post"
        ...
        <div class="control-group">
            ...
            <span style="color:red;font-size:12px;">(注意：只能上传图片）</span>
        </div>
