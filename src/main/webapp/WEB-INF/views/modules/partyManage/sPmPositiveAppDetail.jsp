	...
	<form:form id="inputForm" modelAttribute="sPmPositiveApp" action="${ctx}/partyManage/sPmPositiveApp/save" method="post" class="form-horizontal">
		...
		<div class="controls-group" id="viewImg">
			...
			<tr>
	                ...
	                <c:choose>
	                    <c:when test="${sPmPositiveApp.fileUrl == null }">
	                        <a href="#" role="button" class="btn">下载</a></c:when>
	                    <c:otherwise>
	                        <a href="${ctx}/partyManage/public/downfile?fileUrl=${sPmPositiveApp.fileUrl}"
	                           role="button"
	                           class="btn">下载</a>
	                    </c:otherwise>
	                </c:choose>
		            ...
		            <td>
		                    ${sPmPositiveApp.fileName}
		            </td>
		            <td>
		                    ${sPmPositiveApp.uploader}
		            </td>
		            <td>
		                <fmt:formatDate value="${sPmPositiveApp.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
		            </td>
	        </tr>
