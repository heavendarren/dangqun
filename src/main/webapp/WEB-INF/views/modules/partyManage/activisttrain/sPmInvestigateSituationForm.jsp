...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadInvestigateSituation = new plupload.Uploader({
            runtimes: 'html5,flash,silverlight,html4',
            browse_button: 'investigateSituationFiles', // you can pass in id...
            ...
            init: {
                ...
                FilesAdded: function (up, files) {
                    uploadInvestigateSituation.start();
                },
        ...
        uploadInvestigateSituation.init();
    });
</script>
<div id="container">
    <form:form id="inputForm" modelAttribute="sPmInvestigateSituation"
               action="${ctx}/partyManage/sPmInvestigateSituation/save" method="post" class="form-horizontal">
        <form:hidden path="id"/>
        ...
        <div class="controls-group" id="viewImg">
            ...
            <div class="controls">
                <input name="uploadTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                       value="<fmt:formatDate value="${sPmInvestigateSituation.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
            </div>
        </div>

        <div class="controls-group" id="fileOperat">
            <div class="controls">
                <input id="investigateSituationFiles" class="btn btn-primary" type="button" value="选择文件"/>
            </div>
        </div>

        <div class="form-actions">
            <input id="sPmInvestigateSituationBtnSubmit" class="btn btn-primary" type="submit" value="保 存"/>
            <input id="sPmInvestigateSituationBtnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
        </div>
    </form:form>
</div>