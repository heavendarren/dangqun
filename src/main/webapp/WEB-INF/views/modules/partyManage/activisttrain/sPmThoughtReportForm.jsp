...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadThoughtReprot = new plupload.Uploader({
            runtimes: 'html5,flash,silverlight,html4',
            browse_button: 'thoughtReprotFiles', // you can pass in id...
        ...
        uploadThoughtReprot.init();
    });
</script>

<div id="container">
    <form:form id="inputForm" modelAttribute="sPmThoughtReport" action="${ctx}/partyManage/sPmThoughtReport/save"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="outline" htmlEscape="false" rows="3" maxlength="64" class="input-xlarge "/>
            </div>
        </div>
        ...
        <div class="controls-group" id="fileOperat">
            <div class="controls">
                <input id="thoughtReprotFiles" class="btn btn-primary" type="button" value="选择文件"/>
            </div>
        </div>
        <div class="form-actions">
            <input id="sPmThoughtReportBtnSubmit" class="btn btn-primary" type="submit" value="保 存"/>
                <%--<input id="sPmThoughtReportBtnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>--%>
        </div>
    </form:form>
</div>