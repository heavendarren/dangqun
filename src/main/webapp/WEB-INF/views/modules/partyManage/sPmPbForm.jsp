...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	...
	<form:form id="inputForm" modelAttribute="sPmPb" action="${ctx}/partyManage/sPmPb/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
            	<sys:treeselect2 id="sPmPbPlace" name="sPmPb" value="${sPmPb.place}"
                             labelName="placeName"
                             labelValue="${fns:getDictLabel(sPmPb.place, 'JG', '')}"
		...
		<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect2 id="sPmPbHost" name="sPmPb" value="${sPmPb.host}"
                             labelName="hostName"
                             labelValue="${fns:getDictLabel(sPmPb.host, 'CYLB', '')}"
		...
		<div class="control-group">
				...
				<div class="controls">
					<sys:treeselect2 id="sPmPbnoteTaker" name="sPmPb" value="${sPmPb.noteTaker}"
                             labelName="noteTakerName"
                             labelValue="${fns:getDictLabel(sPmPb.noteTaker, 'CYLB', '')}"
		...
		<div class="control-group">
			...
			<div class="controls">
            	<sys:treeselect2 id="sPmPbperAtt" name="sPmPb" value="${sPmPb.perAtt}"
                             labelName="perAttName"
                             labelValue="${fns:getDictLabel(sPmPb.perAtt, 'CYLB', '')}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="meetMin" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<%-- <div class="control-group">
		...
		<div class="form-actions">
			<input id="sPmPbSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;
			<input id="sPmPbCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
		</div>
	</form:form>
