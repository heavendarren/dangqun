...
<body>
<div id="container">
    <form:form id="inputForm" modelAttribute="sPmTermTrain" action="${ctx}/partyManage/sPmTermTrain/save" method="post"
        ...
        <div class="form-actions">
            <input id="sPmTermTrainBtnSubmit" class="btn btn-primary" type="submit" value="保 存"/>
            <input id="sPmTermTrainBtnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
        </div>
    </form:form>
</div>
</body>
