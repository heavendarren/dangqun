...
<body>
<div id="container">
	<form:form id="inputForm" modelAttribute="sPmMeetingMinutes" action="${ctx}/partyManage/sPmMeetingMinutes/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="controls-group" id="viewImg">
			...
			<div class="controls">
				<input name="uploadTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					   value="<fmt:formatDate value="${sPmMeetingMinutes.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
			</div>
		</div>
		...
		<div class="form-actions">
	        ...
	        <div class="controls">
	            <a href="${ctx}/partyManage/public/MeetingMinutes" role="button" class="btn">征求党员意见会议纪要表下载</a>
	        </div>
   	    </div>
	</form:form>
</div>
