...
<body>
	<div id="container">
		<form:form id="inputForm" modelAttribute="sPmPositivePre"
			action="${ctx}/partyManage/sPmPositivePre/save" method="post"
			...
			<div class="controls-group" id="viewImg">
				...
				<div class="controls">
					<input name="uploadTime" type="text" readonly="readonly"
						...
						value="<fmt:formatDate value="${sPmPositivePre.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<a href="${ctx}/partyManage/public/PositivePre" role="button"
						class="btn">转正工作预审表下载</a>
				</div>
			</div>
		</form:form>
	</div>
