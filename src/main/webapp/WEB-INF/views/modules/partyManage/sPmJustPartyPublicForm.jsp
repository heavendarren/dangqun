...
<body>
<div id="container">
    <form:form id="inputForm" modelAttribute="sPmJustPartyPublic" action="${ctx}/partyManage/sPmJustPartyPublic/save"
        ...
        <div class="controls-group" id="viewImg">
            ...
            <div class="controls">
                ...
                <c:choose>
                    <c:when test="${sPmJustPartyPublic.fileUrl == null }">
                        <a href="#" role="button" class="btn">下载</a></c:when>
                    <c:otherwise>
                        <a href="${ctx}/partyManage/public/downfile?fileUrl=${sPmJustPartyPublic.fileUrl}" role="button"
                           class="btn">下载</a>
                    </c:otherwise>
                </c:choose>
            </div>
            ...
            <div class="controls">
                <input name="uploadTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                       value="<fmt:formatDate value="${sPmJustPartyPublic.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
            </div>
        </div>
        ...
        <div class="form-actions">
            <input id="sPmJustPartyPublicSubmit" class="btn btn-primary" type="submit" value="保 存"/>
            <input id="sPmJustPartyPublicCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
        </div>
    </form:form>
</div>
</body>
