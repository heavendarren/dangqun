...
<div id="container">	
	<form:form id="inputForm" modelAttribute="sPmMrs" 
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="recTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${sPmMrs.recTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
           <sys:treeselect2 disabled="disabled" id="recLoca" name="recLoca" value="${sPmMrs.recLoca}"
                             labelName="recLocaName"
                             labelValue="${fns:getDictLabel(sPmMrs.recLoca, 'JG', '')}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input readonly="true" path="attend" htmlEscape="false" maxlength="18" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
	  ...
	  <div class="controls-group" id="viewImg">
            ...
            <div class="controls">
                ...
                <c:choose>
                    <c:when test="${sPmMrs.fileUrl == null }">
                        <a href="#" role="button" class="btn">下载</a></c:when>
                    <c:otherwise>
                        <a href="${ctx}/partyManage/public/downfile?fileUrl=${sPmMrs.fileUrl}" role="button"
                           class="btn">下载</a>
                    </c:otherwise>
                </c:choose>
            </div>
