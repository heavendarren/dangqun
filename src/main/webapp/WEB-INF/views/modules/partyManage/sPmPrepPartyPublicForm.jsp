...
<body>
<div id="container">
    <form:form id="inputForm" modelAttribute="sPmPrepPartyPublic" action="${ctx}/partyManage/sPmPrepPartyPublic/save"
        ...
        <div class="control-group">
            <a href="${ctx}/partyManage/public/preppublic" role="button" class="btn">公示表下载</a>
            <a href="${ctx}/partyManage/public/prepsituation" role="button" class="btn">公示情况表下载</a>
        </div>
        <div class="controls-group" id="viewImg">
            ...
            <div class="controls">
                ...
                <c:choose>
                    <c:when test="${sPmPrepPartyPublic.fileUrl == null }">
                        <a href="#" role="button" class="btn">下载</a></c:when>
                    <c:otherwise>
                        <a href="${ctx}/partyManage/public/downfile?fileUrl=${sPmPrepPartyPublic.fileUrl}" role="button"
                           class="btn">下载</a>
                    </c:otherwise>
                </c:choose>
            </div>
            ...
            <div class="controls">
                <input name="uploadTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                       value="<fmt:formatDate value="${sPmPrepPartyPublic.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
            </div>
        </div>
        ...
        <div class="form-actions">
            <input id="sPmPrepPartyPublicBtnSubmit" class="btn btn-primary" type="submit" value="保 存"/>
            <input id="sPmPrepPartyPublicBtnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
        </div>
    </form:form>
</div>
</body>
