...
<body>
<div id="container">
	<form:form id="inputForm" modelAttribute="sPmAuditChecklist" action="${ctx}/partyManage/sPmAuditChecklist/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="controls-group" id="viewImg">
			...
			<div class="controls">
				<input name="uploadTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					   value="<fmt:formatDate value="${sPmAuditChecklist.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
			</div>
		</div>
		...
		<div class="form-actions">
			<input id="btnSubmit" class="btn btn-primary" onclick="formSubmit()" type="button" value="保 存"/>
			  <script type="text/javascript">
					function formSubmit(){
		...
		<div class="control-group">
	        ...
	        <div class="controls">
	            <a href="${ctx}/partyManage/public/AuditChecklist" role="button" class="btn">备案表下载</a>
	        </div>
   	    </div>
	</form:form>
</div>
