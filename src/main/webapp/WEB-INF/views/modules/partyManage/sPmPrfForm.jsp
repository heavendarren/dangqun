...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/partyManage/sPmPrf/form"></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sPmPrf" action="${ctx}/partyManage/sPmPrf/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" name="proId" value="${sPmPrf.proId}"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">推荐对象：</label>
			<div class="controls">
				<form:input path="recOb" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="offCap" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<%-- <div class="control-group">
		...
		<div class="control-group">
	        ...
	        <div class="controls">
	            <a href="${ctx}/partyManage/download/prf" role="button" class="btn">群团推优表下载</a>
	        </div>
    	</div>
