...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/partyManage/sPmMrs/form"></a></li>
	</ul>
	<br/>
	<form:form id="inputForm" modelAttribute="sPmMrs" action="${ctx}/partyManage/sPmMrs/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="attend" htmlEscape="false" maxlength="18" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
	        ...
	        <div class="controls">
	            <a href="${ctx}/partyManage/download/mrs" role="button" class="btn">群众推荐汇总表下载</a>
	        </div>
    	</div>
	</form:form>
