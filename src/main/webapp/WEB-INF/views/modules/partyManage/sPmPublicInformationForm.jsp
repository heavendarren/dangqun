...
<div id="container">
    <form:form id="inputForm" modelAttribute="sPmPublicInformation"
               action="${ctx}/partyManage/sPmPublicInformation/save" method="post" class="form-horizontal">
        <form:hidden path="id"/>
        ...
        <div class="controls-group">
            <div class="controls">
                <label>
                    上传操作人：<input readonly="true" name="uploader" value="${sPmPublicInformation.uploader}"
                                 maxlength="255" class="input-xlarge"/>
                </label>
                <label>
                    上传时间：<input name="uploadTime" type="text" readonly="readonly" maxlength="20"
                                class="input-medium Wdate "
                                value="<fmt:formatDate value="${sPmPublicInformation.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
                </label>
            </div>
        </div>
        ...
        <div class="form-actions">
            <input id="sPmPublicInformationBtnSubmit" class="btn btn-primary" type="submit" value="保存"/>
            <%--<input id="sPmPublicInformationBtnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>--%>
        </div>
    </form:form>
