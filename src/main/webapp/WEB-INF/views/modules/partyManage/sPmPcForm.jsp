...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	...
	<form:form id="inputForm" modelAttribute="sPmPc" action="${ctx}/partyManage/sPmPc/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<input id="sPmPcSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;
			<input id="sPmPcCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
		</div>
	</form:form>
