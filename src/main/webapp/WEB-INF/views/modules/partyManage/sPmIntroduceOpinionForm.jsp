...
<body>
	<div id="container">
		<form:form id="inputForm" modelAttribute="sPmIntroduceOpinion"
			action="${ctx}/partyManage/sPmIntroduceOpinion/save" method="post"
			class="form-horizontal">
			<form:hidden path="id" />
			<sys:message content="${message}" />
			<h3>入党介绍人和党小组意见表上传：</h3>
			<div class="controls-group" id="viewImg">
				...
				<div class="controls">
					<input name="uploadTime" type="text" readonly="readonly"
						...
						value="<fmt:formatDate value="${sPmIntroduceOpinion.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<a href="${ctx}/partyManage/public/IntroduceOpinion" role="button"
						class="btn">入党介绍人和党小组意见表下载</a>
				</div>
			</div>
		</form:form>
	</div>
