...
<body>
<form:form id="inputForm" modelAttribute="sPmPc" action="${ctx}/partyManage/regular/sPmPc/save" method="post"
    ...
    <div class="form-actions">
        <input id="sPmPcBtnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;
            <%--<input id="sPmPcBtnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>--%>
    </div>
</form:form>
</body>
</html>