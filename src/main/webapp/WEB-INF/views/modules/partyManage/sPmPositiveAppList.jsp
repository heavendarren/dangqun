...
<body>
	...
	<form:form id="searchForm" modelAttribute="sPmPositiveApp" action="${ctx}/partyManage/sPmPositiveApp/" method="post" class="breadcrumb form-search">
	...
	<sys:message content="${message}"/>
		...
		<div class="controls" >
			<label><c:if test="${item.remarks == 'img' }">图片</c:if>
				   ...
				   <c:if test="${item.remarks == 'files' }">文件</c:if>
